...
# Define Rastrigin function (2D version)
...
sa = SimulatedAnnealing(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Simulated Annealing Search on Rastrigin Function")
plt.legend()
plt.savefig("SA.png")
