...
from coral_reefs_optimization import CoralReefsOptimization
...
# Run Coral Reefs Optimization Algorithm
cro = CoralReefsOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = cro.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Coral Reefs Optimization on Rastrigin Function")
plt.legend()
plt.savefig("CRO.png")
