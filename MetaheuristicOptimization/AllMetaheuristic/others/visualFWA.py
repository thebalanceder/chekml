...
# Run Fireworks Algorithm for Rastrigin function
fwa = FireworksAlgorithm(num_fireworks=10, num_sparks=5, dim=2, bounds=bounds)
best_solution, best_value, history = fwa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Fireworks Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("FWA.png")
