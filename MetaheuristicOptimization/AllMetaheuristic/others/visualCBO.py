...
from colliding_bodies_optimization import CollidingBodiesOptimization
...
# Run Colliding Bodies Optimization Algorithm
cbo = CollidingBodiesOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = cbo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Colliding Bodies Optimization on Rastrigin Function")
plt.legend()
plt.savefig("CBO.png")
