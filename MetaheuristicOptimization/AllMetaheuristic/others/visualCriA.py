...
# Run Cricket Algorithm
ca = CricketAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ca.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Cricket Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("CA.png")
