...
# Run Artificial Algae Algorithm
aaa = ArtificialAlgaeAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Artificial Algae Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("AAA.png")
