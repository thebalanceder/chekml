...
# Run Local Search
ls = LocalSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ls.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Local Search on Rastrigin Function")
plt.legend()
plt.savefig("LS.png")
