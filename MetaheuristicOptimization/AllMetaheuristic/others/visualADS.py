...
from adaptive_dimensional_search import AdaptiveDimensionalSearch
...
# Run Adaptive Dimensional Search Algorithm
ads = AdaptiveDimensionalSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ads.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Adaptive Dimensional Search on Rastrigin Function")
plt.legend()
plt.savefig("ADS.png")
