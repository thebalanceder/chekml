...
from bottlenose_dolphin_optimization import BottlenoseDolphinOptimization
...
# Run Bottlenose Dolphin Optimization Algorithm
bdo = BottlenoseDolphinOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = bdo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Bottlenose Dolphin Optimization on Rastrigin Function")
plt.legend()
plt.savefig("BDO.png")
