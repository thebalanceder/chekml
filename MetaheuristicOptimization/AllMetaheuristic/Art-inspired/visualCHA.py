...
from color_harmony_algorithm import ColorHarmonyAlgorithm
...
# Run Color Harmony Algorithm
cha = ColorHarmonyAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = cha.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Color Harmony Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("CHA.png")
