...
from flower_pollination_algorithm import FlowerPollinationAlgorithm
...
# Run Flower Pollination Algorithm
fpa = FlowerPollinationAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Flower Pollination Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("FPA.png")
