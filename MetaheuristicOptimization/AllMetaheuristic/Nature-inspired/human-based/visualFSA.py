...
from future_search_algorithm import FutureSearchAlgorithm
...
# Run Future Search Algorithm
fsa = FutureSearchAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Future Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("FSA.png")
