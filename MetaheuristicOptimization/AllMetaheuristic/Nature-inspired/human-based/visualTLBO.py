...
from tlbo import TeachingLearningBasedOptimization
...
# Run Teaching-Learning-Based Optimization Algorithm for Rastrigin function
tlbo = TeachingLearningBasedOptimization(num_students=20, dim=2, bounds=bounds)
best_solution, best_value, history = tlbo.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Teaching-Learning-Based Optimization on Rastrigin Function")
plt.legend()
plt.savefig("TLBO.png")
