...
from squid_game_optimizer import SquidGameOptimizer
...
# Run Squid Game Optimizer
sgo = SquidGameOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Squid Game Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("SGO.png")
