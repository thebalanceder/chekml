...
from soccer_league_competition import SoccerLeagueCompetition
...
# Run Soccer League Competition Algorithm
slc = SoccerLeagueCompetition(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = slc.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Soccer League Competition on Rastrigin Function")
plt.legend()
plt.savefig("SLC.png")
