...
from imperialistic_competitive_algorithm import ImperialisticCompetitiveAlgorithm
...
# Run Imperialistic Competitive Algorithm for Rastrigin function
ica = ImperialisticCompetitiveAlgorithm(num_countries=20, dim=2, bounds=bounds)
best_solution, best_value, history = ica.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Imperialistic Competitive Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("ICA.png")
