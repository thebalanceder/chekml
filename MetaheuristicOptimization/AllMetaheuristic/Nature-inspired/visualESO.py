...
from eagle_strategy import EagleStrategyOptimization
...
# Run Eagle Strategy Optimization Algorithm for Rastrigin function
eso = EagleStrategyOptimization(num_eagles=20, dim=2, bounds=bounds)
best_solution, best_value, history = eso.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Eagle Strategy Optimization on Rastrigin Function")
plt.legend()
plt.savefig("ESO.png")
