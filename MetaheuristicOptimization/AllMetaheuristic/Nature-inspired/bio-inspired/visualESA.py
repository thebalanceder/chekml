...
from elephant_search_algorithm import ElephantSearchAlgorithm
...
# Run Elephant Search Algorithm
esa = ElephantSearchAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = esa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Elephant Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("ESA.png")
