...
from shuffled_frog_leaping import ShuffledFrogLeaping
...
# Run Shuffled Frog Leaping Algorithm for Rastrigin function
sfla = ShuffledFrogLeaping(num_frogs=20, dim=2, bounds=bounds)
best_solution, best_value, history = sfla.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Shuffled Frog Leaping Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SFLA.png")
