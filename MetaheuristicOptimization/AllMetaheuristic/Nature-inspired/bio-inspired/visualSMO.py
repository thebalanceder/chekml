...
from spider_monkey_optimization import SpiderMonkeyOptimization
...
# Run Spider Monkey Optimization Algorithm
smo = SpiderMonkeyOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = smo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Spider Monkey Optimization on Rastrigin Function")
plt.legend()
plt.savefig("SMO.png")
