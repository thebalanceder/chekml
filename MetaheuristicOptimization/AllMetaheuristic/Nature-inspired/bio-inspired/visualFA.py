...
# Run Firefly Algorithm for Rastrigin function
fa = FireflyAlgorithm(num_fireflies=20, dim=2, bounds=bounds)
best_solution, best_value, history = fa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Firefly Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("FA.png")
