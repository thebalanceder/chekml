...
from ant_lion_optimizer import AntLionOptimizer
...
alo = AntLionOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = alo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Ant Lion Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("ALO.png")
