...
from fire_hawk_optimizer import FireHawkOptimizer
...
# Run Fire Hawk Optimizer Algorithm
fho = FireHawkOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = fho.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Fire Hawk Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("FHO.png")
