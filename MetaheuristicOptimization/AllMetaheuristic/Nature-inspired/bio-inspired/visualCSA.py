...
from crow_search_algorithm import CrowSearchAlgorithm
...
# Run Crow Search Algorithm
csa = CrowSearchAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Crow Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("CSA.png")
