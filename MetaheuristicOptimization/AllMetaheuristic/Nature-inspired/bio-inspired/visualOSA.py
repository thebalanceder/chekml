...
from owl_search_algorithm import OwlSearchAlgorithm
...
# Run Owl Search Algorithm
osa = OwlSearchAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Owl Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("OSA.png")
