...
# Run Cuckoo Search Algorithm for Rastrigin function
cs = CuckooSearch(num_nests=20, dim=2, bounds=bounds)
best_solution, best_value, history = cs.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Cuckoo Search on Rastrigin Function")
plt.legend()
plt.savefig("CS.png")
