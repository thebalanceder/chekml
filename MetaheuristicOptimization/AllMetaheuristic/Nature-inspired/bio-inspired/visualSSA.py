...
# Run Squirrel Search Algorithm
ssa = SquirrelSearchAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ssa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Squirrel Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SSA.png")
