...
# Run Grey Wolf Optimizer Algorithm
gwo = GreyWolfOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = gwo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Grey Wolf Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("GWO.png")
