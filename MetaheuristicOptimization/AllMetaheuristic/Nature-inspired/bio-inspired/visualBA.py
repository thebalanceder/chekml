...
# Run Bat Algorithm for Rastrigin function
ba = BatAlgorithm(num_bats=20, dim=2, bounds=bounds)
best_solution, best_value, history = ba.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Bat Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("BA.png")
