...
from jaguar_algorithm import JaguarAlgorithm
...
# Run Jaguar Algorithm
ja = JaguarAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Jaguar Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("JA.png")
