...
from black_hole_algorithm import BlackHoleAlgorithm
...
# Run Black Hole Algorithm
bha = BlackHoleAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = bha.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Black Hole Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("BHA.png")
