...
# Run Sine Cosine Algorithm
sca = SineCosineAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = sca.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Sine Cosine Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SCA.png")
