...
from vortex_search_algorithm import VortexSearch
...
# Run Vortex Search Algorithm
vsa = VortexSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = vsa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Vortex Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("VSA.png")
