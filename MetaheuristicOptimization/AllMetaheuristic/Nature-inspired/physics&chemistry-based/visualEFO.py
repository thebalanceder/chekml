...
# Run Electromagnetic Field Optimization Algorithm
efo = ElectromagneticFieldOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Electromagnetic Field Optimization on Rastrigin Function")
plt.legend()
plt.savefig("EFO.png")
