...
from hunting_search import HuntingSearch
...
# Run Hunting Search Algorithm for Rastrigin function
hsa = HuntingSearch(num_hunters=20, dim=2, bounds=bounds)
best_solution, best_value, history = hsa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Hunting Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("HSA.png")
