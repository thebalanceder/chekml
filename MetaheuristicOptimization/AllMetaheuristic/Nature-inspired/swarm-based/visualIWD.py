...
from intelligent_water_drops import IntelligentWaterDrops
...
# Run Intelligent Water Drops Algorithm for Rastrigin function
iwd = IntelligentWaterDrops(num_drops=20, dim=2, bounds=bounds)
best_solution, best_value, history = iwd.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Intelligent Water Drops on Rastrigin Function")
plt.legend()
plt.savefig("IWD_Rastrigin.png")
