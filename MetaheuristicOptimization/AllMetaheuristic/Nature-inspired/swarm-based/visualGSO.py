...
# Run Glowworm Swarm Optimization Algorithm for Rastrigin function
gso = GlowwormSwarmOptimization(num_glowworms=20, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Glowworm Swarm Optimization on Rastrigin Function")
plt.legend()
plt.savefig("GSO.png")
