...
from animal_migration_optimization import AnimalMigrationOptimization
...
# Run Animal Migration Optimization Algorithm
amo = AnimalMigrationOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Animal Migration Optimization on Rastrigin Function")
plt.legend()
plt.savefig("AMO.png")
