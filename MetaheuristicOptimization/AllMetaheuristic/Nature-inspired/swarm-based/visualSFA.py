...
from special_forces_algorithm import SpecialForcesAlgorithm
...
# Run Special Forces Algorithm
sfa = SpecialForcesAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = sfa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Special Forces Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SFA.png")
