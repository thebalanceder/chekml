...
from giza_pyramids_construction import GizaPyramidsConstruction
...
# Run Giza Pyramids Construction Algorithm
gpca = GizaPyramidsConstruction(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = gpca.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Giza Pyramids Construction Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("GPCA.png")
