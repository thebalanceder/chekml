...
ea = EvolutionaryAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ea.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Evolutionary Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("EA.png")
