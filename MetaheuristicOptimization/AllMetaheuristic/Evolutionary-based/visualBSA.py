...
from backtracking_search_algorithm import BacktrackingSearchAlgorithm
...
# Run Backtracking Search Algorithm for Rastrigin function
bsa = BacktrackingSearchAlgorithm(population_size=20, dim=2, bounds=bounds)
best_solution, best_value, history = bsa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Backtracking Search Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("BSA.png")
