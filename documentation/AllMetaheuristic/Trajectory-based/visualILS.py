...
# Run Iterative Local Search
ils = IterativeLocalSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Iterative Local Search on Rastrigin Function")
plt.legend()
plt.savefig("ILS.png")
