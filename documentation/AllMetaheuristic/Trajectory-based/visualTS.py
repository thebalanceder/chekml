...
# Run Tabu Search
tabu = TabuSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = tabu.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Tabu Search on Rastrigin Function")
plt.legend()
plt.savefig("TS.png")
