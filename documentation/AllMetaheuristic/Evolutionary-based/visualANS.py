...
from across_neighborhood_search import AcrossNeighborhoodSearch
...
# Run Across Neighborhood Search Algorithm
ans = AcrossNeighborhoodSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Across Neighborhood Search on Rastrigin Function")
plt.legend()
plt.savefig("ANS.png")
