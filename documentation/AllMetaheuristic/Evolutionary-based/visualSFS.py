...
from stochastic_fractal_search import StochasticFractalSearch
...
# Run Stochastic Fractal Search Algorithm
sfs = StochasticFractalSearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Stochastic Fractal Search on Rastrigin Function")
plt.legend()
plt.savefig("SFS.png")
