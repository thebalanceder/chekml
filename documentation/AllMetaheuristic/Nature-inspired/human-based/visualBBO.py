...
# Run Biogeography-Based Optimization Algorithm for Rastrigin function
bbo = BiogeographyBasedOptimization(num_habitats=20, dim=2, bounds=bounds)
best_solution, best_value, history = bbo.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Biogeography-Based Optimization on Rastrigin Function")
plt.legend()
plt.savefig("BBO.png")
