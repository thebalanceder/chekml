...
from socio_evolution_learning import SocioEvolutionLearning
...
# Run Socio-Evolution and Learning Optimization
selo = SocioEvolutionLearning(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = selo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Socio-Evolution and Learning Optimization on Rastrigin Function")
plt.legend()
plt.savefig("SEL.png")
