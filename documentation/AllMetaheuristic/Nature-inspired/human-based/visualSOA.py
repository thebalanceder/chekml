...
from seeker_optimization_algorithm import SeekerOptimization
...
# Run Seeker Optimization Algorithm for Rastrigin function
soa = SeekerOptimization(num_seekers=20, dim=2, bounds=bounds)
best_solution, best_value, history = soa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Seeker Optimization Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SOA.png")
