...
from artificial_root_foraging import ArtificialRootForaging
...
# Run Artificial Root Foraging Algorithm
arfo = ArtificialRootForaging(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = arfo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Artificial Root Foraging Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("ARF.png")
