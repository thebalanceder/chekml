...
from phototropic_algorithm import PhototropicAlgorithm
...
# Run Phototropic Algorithm
pa = PhototropicAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = pa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Phototropic Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("PA.png")
