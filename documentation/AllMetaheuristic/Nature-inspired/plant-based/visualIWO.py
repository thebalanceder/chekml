...
# Run Invasive Weed Optimization Algorithm for Rastrigin function
iwo = InvasiveWeedOptimization(num_weeds=10, dim=2, bounds=bounds)
best_solution, best_value, history = iwo.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Invasive Weed Optimization on Rastrigin Function")
plt.legend()
plt.savefig("IWO.png")
