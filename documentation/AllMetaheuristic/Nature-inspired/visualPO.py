...
# Run Political Optimizer Algorithm
po = PoliticalOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Political Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("PO.png")
