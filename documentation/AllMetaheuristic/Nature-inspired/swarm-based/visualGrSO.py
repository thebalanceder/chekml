...
from group_search_optimizer import GroupSearchOptimizer
...
# Run Group Search Optimizer for Rastrigin function
gso = GroupSearchOptimizer(num_agents=20, dim=2, bounds=bounds)
best_solution, best_value, history = gso.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Group Search Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("GrSO.png")
