...
# Run Migrating Birds Optimization Algorithm for Rastrigin function
mbo = MigratingBirdsOptimization(num_birds=20, dim=2, bounds=bounds)
best_solution, best_value, history = mbo.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Migrating Birds Optimization on Rastrigin Function")
plt.legend()
plt.savefig("MBO.png")
