...
from radial_movement_optimization import RadialMovementOptimization
...
# Run Radial Movement Optimization Algorithm
rmo = RadialMovementOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = rmo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Radial Movement Optimization on Rastrigin Function")
plt.legend()
plt.savefig("RMO.png")
