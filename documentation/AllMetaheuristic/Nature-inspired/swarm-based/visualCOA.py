...
from coyote_optimization import CoyoteOptimization
...
# Run Coyote Optimization Algorithm
coa = CoyoteOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Coyote Optimization Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("COA.png")
