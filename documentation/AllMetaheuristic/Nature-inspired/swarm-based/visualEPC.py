...
from emperor_penguins_colony import EmperorPenguinsColony
...
# Run Emperor Penguins Colony Algorithm
epc = EmperorPenguinsColony(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = epc.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Emperor Penguins Colony Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("EPC.png")
