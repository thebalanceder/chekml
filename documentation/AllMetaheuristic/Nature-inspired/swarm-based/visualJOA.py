...
# Run Joint Operations Algorithm
joa = JointOperationsAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Joint Operations Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("JOA.png")
