...
from keshtel_algorithm import KeshtelAlgorithm
...
# Run Keshtel Algorithm
ka = KeshtelAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ka.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Keshtel Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("KA.png")
