...
from artificial_fish_swarm_algorithm import ArtificialFishSwarm
...
# Run Artificial Fish Swarm Algorithm
afsa = ArtificialFishSwarm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = afsa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Artificial Fish Swarm Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("AFSA.png")
