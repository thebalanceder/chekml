...
from water_wave_optimization import WaterWaveOptimization
...
# Run Water Wave Optimization Algorithm
wwo = WaterWaveOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = wwo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Water Wave Optimization on Rastrigin Function")
plt.legend()
plt.savefig("WWO.png")
