...
from chemical_reaction_optimization import ChemicalReactionOptimization
...
# Run Chemical Reaction Optimization Algorithm for Rastrigin function
cro = ChemicalReactionOptimization(num_molecules=20, dim=2, bounds=bounds)
best_solution, best_value, history = cro.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Chemical Reaction Optimization on Rastrigin Function")
plt.legend()
plt.savefig("CRO.png")
