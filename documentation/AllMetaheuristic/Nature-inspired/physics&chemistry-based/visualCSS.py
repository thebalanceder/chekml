...
from charged_system_search import ChargedSystemSearch
...
# Run Charged System Search Algorithm for Rastrigin function
css = ChargedSystemSearch(num_particles=20, dim=2, bounds=bounds)
best_solution, best_value, history = css.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Charged System Search on Rastrigin Function")
plt.legend()
plt.savefig("CSS.png")
