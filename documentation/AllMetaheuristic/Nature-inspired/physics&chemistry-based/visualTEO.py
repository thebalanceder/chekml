...
from thermal_exchange_optimization import ThermalExchangeOptimization
...
# Run Thermal Exchange Optimization Algorithm
teo = ThermalExchangeOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Thermal Exchange Optimization on Rastrigin Function")
plt.legend()
plt.savefig("TEO.png")
