...
mfo = MothFlameOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = mfo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Moth-Flame Optimization on Rastrigin Function")
plt.legend()
plt.savefig("MFO.png")
