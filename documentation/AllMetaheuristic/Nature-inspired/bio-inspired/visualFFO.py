...
from flying_fox_optimization import FlyingFoxOptimization
...
# Run Flying Fox Optimization Algorithm
ffoa = FlyingFoxOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = ffoa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Flying Fox Optimization Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("FFOA.png")
