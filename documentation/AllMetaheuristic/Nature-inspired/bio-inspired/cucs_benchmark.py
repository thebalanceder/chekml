...
# Adapted to Cython from Python implementation
# Original MATLAB Programming dates: Nov 2008 to June 2009
# Original MATLAB Last revised: Dec 2009
# Python/Cython adaptation: April 2025
# -----------------------------------------------------------------
...
# -----------------------------------------------------------------
# This Cython implementation follows the standard version of
# Cuckoo Search (CS) with Levy flights, using NumPy for vectorized
# operations and Cython for performance optimization.
# -----------------------------------------------------------------
# Notes:
# Different implementations may lead to slightly different
# behavior and/or results, but this is the nature of random walks
# and all metaheuristics.
# -----------------------------------------------------------------
...
cdef class CuckooSearchOptimizer:
    ...
    def __init__(self, object objective_function, ITYPE_t dim, object bounds, 
                 ITYPE_t population_size=25, ITYPE_t max_iter=1000, DTYPE_t pa=0.25):
        """
...
cdef DTYPE_t sphere_function(cnp.ndarray[DTYPE_t, ndim=1] u):
    """
    Objective function: d-dimensional sphere function sum_j=1^d (u_j-1)^2.
    Minimum at (1, 1, ..., 1).
    """
    cdef DTYPE_t sum_squares = 0.0
    cdef ITYPE_t i
...
if __name__ == "__main__":
    ...
    dim = 15
    bounds = [(-5, 5)] * dim
    optimizer = CuckooSearchOptimizer(sphere_function, dim, bounds)
