...
from ant_colony_optimization import AntColonyOptimizationRastrigin
...
# Run Ant Colony Optimization Algorithm for Rastrigin function
aco = AntColonyOptimizationRastrigin(num_ants=10, dim=2, bounds=bounds)
best_solution, best_value, history = aco.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Ant Colony Optimization on Rastrigin Function")
plt.legend()
plt.savefig("ACO.png")
