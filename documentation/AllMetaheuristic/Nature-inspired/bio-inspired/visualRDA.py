...
# Run Red Deer Algorithm
rda = RedDeerAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Red Deer Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("RDA.png")
