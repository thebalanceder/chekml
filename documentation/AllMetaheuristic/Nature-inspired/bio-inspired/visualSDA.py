...
from sda_algorithm import SlimeMouldAlgorithm
...
sda = SlimeMouldAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = sda.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Slime Mould Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("SDA.png")
