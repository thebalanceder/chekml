...
from monkey_algorithm import MonkeyAlgorithm
...
# Run Monkey Algorithm for Rastrigin function
ma = MonkeyAlgorithm(num_monkeys=20, dim=2, bounds=bounds)
best_solution, best_value, history = ma.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Monkey Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("MA.png")
