...
from cuckoo_optimization import CuckooOptimization
...
# Run Cuckoo Optimization Algorithm for Rastrigin function
coa = CuckooOptimization(num_nests=20, dim=2, bounds=bounds)
best_solution, best_value, history = coa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Cuckoo Optimization Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("CO.png")
