...
from mayfly_optimization import MayflyOptimization
...
# Run Mayfly Optimization Algorithm
moa = MayflyOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = moa.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Mayfly Optimization Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("MOA.png")
