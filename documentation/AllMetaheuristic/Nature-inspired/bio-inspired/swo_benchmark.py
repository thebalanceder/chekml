...
for name, func in benchmark_functions.items():
    ...
    # For visualization, we'll simulate a path by sampling positions (approximation)
    x_vals = [best_solution[0]]  # Using best solution for simplicity
    y_vals = [best_solution[1]]
    # Note: SWO doesn't provide per-iteration positions, so we focus on the final solution
