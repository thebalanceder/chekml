...
from chicken_swarm_optimization import ChickenSwarmOptimization
...
# Run Chicken Swarm Optimization Algorithm
cso = ChickenSwarmOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = cso.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Chicken Swarm Optimization on Rastrigin Function")
plt.legend()
plt.savefig("CSO.png")
