...
from virus_colony_search import VirusColonySearch
...
# Run Virus Colony Search Algorithm
vcs = VirusColonySearch(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = vcs.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Virus Colony Search on Rastrigin Function")
plt.legend()
plt.savefig("VCS.png")
