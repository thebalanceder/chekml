...
from harris_hawks_optimization import HarrisHawksOptimization
...
# Run Harris Hawks Optimization Algorithm
hho = HarrisHawksOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = hho.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Harris Hawks Optimization on Rastrigin Function")
plt.legend()
plt.savefig("HHO.png")
