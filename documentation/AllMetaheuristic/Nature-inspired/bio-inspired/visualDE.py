...
from dolphin_echolocation import DolphinEcholocation
...
dea = DolphinEcholocation(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Dolphin Echolocation Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("DEA.png")
