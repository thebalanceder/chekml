...
# Run Emperor Penguin Optimizer
epo = EmperorPenguinOptimizer(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Emperor Penguin Optimizer on Rastrigin Function")
plt.legend()
plt.savefig("EPO.png")
