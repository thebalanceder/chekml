...
from krill_herd_algorithm import KrillHerdAlgorithm
...
# Run Krill Herd Algorithm for Rastrigin function
kha = KrillHerdAlgorithm(num_krill=20, dim=2, bounds=bounds)
best_solution, best_value, history = kha.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Krill Herd Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("KHA.png")
