...
from key_cutting_algorithm import KeyCuttingAlgorithm, measurement_placement_fitness
import time
...
for name, func in benchmark_functions.items():
    ...
    # For KCA, we adapt the continuous benchmark functions to binary by discretizing the search space
    def binary_fitness(key, _):
        ...
        for i in range(2):  # 2D problem
            ...
            # Convert binary to decimal (0 to 1023), then scale to [-5, 5]
