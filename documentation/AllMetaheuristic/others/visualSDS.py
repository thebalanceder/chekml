...
from stochastic_diffusion_search import StochasticDiffusionSearch
...
# Run Stochastic Diffusion Search Algorithm for Rastrigin function
sds = StochasticDiffusionSearch(num_agents=20, dim=2, bounds=bounds)
best_solution, best_value, history = sds.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Stochastic Diffusion Search on Rastrigin Function")
plt.legend()
plt.savefig("SDS.png")
