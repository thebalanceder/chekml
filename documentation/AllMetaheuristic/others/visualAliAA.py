...
from alienated_ant_algorithm import AlienatedAntAlgorithm
...
# Run Alienated Ant Algorithm
aaa = AlienatedAntAlgorithm(objective_function=rastrigin_function, dim=2, bounds=bounds)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Alienated Ant Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("AliAA.png")
