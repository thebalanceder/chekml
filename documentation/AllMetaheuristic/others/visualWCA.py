...
from water_cycle_algorithm import WaterCycleAlgorithm
...
# Run Water Cycle Algorithm for Rastrigin function
wca = WaterCycleAlgorithm(num_drops=20, num_rivers=3, dim=2, bounds=bounds)
best_solution, best_value, history = wca.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Water Cycle Algorithm on Rastrigin Function")
plt.legend()
plt.savefig("WCA.png")
