...
from fruit_fly_optimization import FruitFlyOptimization
...
# Run Fruit Fly Optimization Algorithm for Rastrigin function
foa = FruitFlyOptimization(num_flies=20, dim=2, bounds=bounds)
best_solution, best_value, history = foa.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Fruit Fly Optimization on Rastrigin Function")
plt.legend()
plt.savefig("FFO.png")
