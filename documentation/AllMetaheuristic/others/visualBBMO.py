...
from bumble_bee_mating import BumbleBeeMatingOptimization
...
# Run Bumble Bee Mating Optimization Algorithm
bbmo = BumbleBeeMatingOptimization(objective_function=rastrigin_function, dim=2, bounds=bounds)
best_solution, best_value, history = bbmo.optimize()
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Bumble Bee Mating Optimization on Rastrigin Function")
plt.legend()
plt.savefig("BBMO.png")
