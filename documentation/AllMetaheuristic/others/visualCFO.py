...
from central_force_optimization import CentralForceOptimization
...
# Run Central Force Optimization Algorithm for Rastrigin function
cfo = CentralForceOptimization(num_probes=20, dim=2, bounds=bounds)
best_solution, best_value, history = cfo.optimize(rastrigin_function)
...
plt.xlabel("X1")
plt.ylabel("X2")
plt.title("Central Force Optimization on Rastrigin Function")
plt.legend()
plt.savefig("CFO.png")
