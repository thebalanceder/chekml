...
IFed_df_train = featurizer.featurize(df=X_train_tab.copy(), level=2, stage=2)
...
try:
    IFed_df_val = featurizer.featurize(df=X_val_tab.copy(), level=2, stage=2)
...
if test_df is not None:
  ...
  try:
    ...
    IFed_df_test = featurizer.featurize(df=test_tab_only.copy(), level=2, stage=2)
