...
from dujiangyan_optimizer import DujiangyanIrrigationOptimizer #dujiangyan_irrigation_optimizer
import time
...
for name, func in benchmark_functions.items():
    ...
    diso = DujiangyanIrrigationOptimizer(objective_function=func, dim=2, bounds=bounds)
